...
def parse_args():
    ...
    parser.add_argument('--img_file',
                        default="/data2/huangjunjia/coco/CoNSeP_1000x1000/CoNSeP_Test/",
                        help='Image file')
    parser.add_argument('--img_file_256',
                        default="/data2/huangjunjia/coco/COCO_CoNSeP_256/CoNSeP_Test/",
                        help='Image file')
    parser.add_argument('--config',
                        default="/data2/huangjunjia/coco/CoNSeP_1000x1000/Checkpoints/Paper/GlobalLocal_3Trans_STNSequence_FromScratchV81/STNSequenceV2.py",
                        help='Config file')
    parser.add_argument('--checkpoint',
                        default="/data2/huangjunjia/coco/CoNSeP_1000x1000/Checkpoints/Paper/GlobalLocal_3Trans_STNSequence_FromScratchV81/best_F1d_iter_800.pth",
                        help='Checkpoint file')
    parser.add_argument('--gt-file',
                        default="/data2/huangjunjia/coco/CoNSeP_1000x1000/test/gt_mat/",
                        help='Path to output file')
    parser.add_argument('--gt-file_256',
                        default="/data2/huangjunjia/coco/COCO_CoNSeP_256/test/gt_mat/",
                        help='Path to output file')
    parser.add_argument(
...
def main(args):
    ...
    if thr:
        ...
        # p-value
        import pandas as pd
        filename = "/data2/huangjunjia/coco/p_result/p_result_acformer_f1c.xlsx"
        dfData = {'Method': 'ACFormer'}
        ...
        for img_indx, img_name in enumerate(img_list):
            ...
            for raw in range(2):
                for col in range(2):
                    ...
                    for cls in range(num_classes):
                        ...
                        classes[:, 0] += col * col_offset
                        classes[:, 1] += raw * raw_offset
            ...
            f1_c = np.mean(results_list)
            dfData[img_name].append(f1_c)
            # p-value
