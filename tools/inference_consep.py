...
def parse_args():
    ...
    parser.add_argument('--img_file',
                        default="Path/CoNSeP/CoNSeP_Test/",
                        help='Image file')
    parser.add_argument('--img_file_256',
                        default="Path/CoNSeP/CoNSeP_Test/",
                        help='Image file')
    parser.add_argument('--config',
                        default="Path to CoNSeP config file",
                        help='Config file')
    parser.add_argument('--checkpoint',
                        default="Path to CoNSeP checkpoint file",
                        help='Checkpoint file')
    parser.add_argument('--gt-file',
                        default="Path/CoNSeP/test/gt_mat/",
                        help='Path to output file')
    parser.add_argument('--gt-file_256',
                        default="Path/COCO_CoNSeP_256/test/gt_mat/",
                        help='Path to output file')
    parser.add_argument(
