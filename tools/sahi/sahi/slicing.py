    ...
    while y_max < image_height:
        ...
        while x_max < image_width:
            ...
            # SAHI Modify
                ...
                if y_max + slice_height > image_height:
                    if x_max + slice_width > image_width:
                        slice_bboxes.append([x_min, y_min, image_width, image_height])
                        x_max = image_width
                    else:
                        slice_bboxes.append([x_min, y_min, x_max, image_height])
                    y_max = image_height
                elif x_max + slice_width > image_width:
                    if y_max + slice_height > image_height:
                        slice_bboxes.append([x_min, y_min, image_width, image_height])
                        y_max = image_height
                    else:
                        slice_bboxes.append([x_min, y_min, image_width, y_max])
                    x_max = image_width
                else:
                    slice_bboxes.append([x_min, y_min, x_max, y_max])
