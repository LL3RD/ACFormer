...
def parse_args():
    ...
    parser.add_argument('--img_file',
                        default="/data2/huangjunjia/coco/BRCA/HoverNet_BRCA/Test/Images",
                        help='Image file')
    parser.add_argument('--img_file_256',
                        default="/data2/huangjunjia/coco/BRCA/COCO_BRCA/BRCA_Test/",
                        help='Image file')
    parser.add_argument('--config',
                        default="/data2/huangjunjia/coco/BRCA/Checkpoints/Paper/STN_Paper/STNSequence_BRCA.py",
                        help='Config file')
    parser.add_argument('--checkpoint',
                        default="/data2/huangjunjia/coco/BRCA/Checkpoints/Paper/STN_Paper/best_F1d_iter_35200.pth",
                        help='Checkpoint file')
    parser.add_argument('--gt-file',
                        default="/data2/huangjunjia/coco/BRCA/HoverNet_BRCA/Test/Labels",
                        help='Path to output file')
    parser.add_argument('--gt-file_256',
                        default="/data2/huangjunjia/coco/BRCA/COCO_BRCA/test/gt_mat/",
                        help='Path to output file')
    parser.add_argument(
...
def main(args):
    ...
    if thr:
        ...
        for img_indx, img_name in enumerate(img_list):
            ...
            sio.savemat(os.path.join("/data2/huangjunjia/coco/Visual/QuantitiveC/BRCA/Ours/", img_name[:-4]+".mat"), pred_mat)
            ...
            # plt.axis("off")
            # plt.savefig(os.path.join(gt_save_path, img_name), dpi=400)
            # # plt.show()
            # plt.clf()
            #
            # plt.imshow(img)
            ...
            #                 color=(int(1 == cls), int(2 == cls), int(3 == cls)))
            # plt.axis("off")
            # plt.savefig(os.path.join(pred_save_path, img_name), dpi=400)
            # # plt.show()
            # plt.clf()
