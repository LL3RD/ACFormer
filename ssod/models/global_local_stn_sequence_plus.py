...
class GlobalLocal_STN_Sequence_PLUS(MultiSteamDetector):
    def __init__(self, model: dict, train_cfg=None, test_cfg=None, stn_cfg=None):
        super(GlobalLocal_STN_Sequence_PLUS, self).__init__(
        ...
        self.transformer = ParallelBlock(dim=self.embed, num_heads=self.num_heads, qkv_bias=True, )
        ...
        self.fc_loc[0].bias.data.copy_(torch.tensor([0.5, 0, -0.5, 0, 0.5, -0.5,
                                                     0.5, 0, -0.5, 0, 0.5, 0.5,
                                                     0.5, 0, 0.5, 0, 0.5, -0.5,
    ...
    def adaptive_affine_transformer(self, data_groups):
    ...
    def forward_train(self, img, img_metas, **kwargs):
        ...
        data_groups["local"] = self.adaptive_affine_transformer(data_groups["local"])
